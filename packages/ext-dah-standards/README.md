...
```ts
import DAH_standards, { Sign, VisualType, Duration } from "@nrs-org/ext-dah-standards";
...
const impact = ext.emotion(ctx, contributors, 3.0, [[AP, 0.8], [MP, 0.5]]);
...
const pads = ext.pads(ctx, contributors, [
