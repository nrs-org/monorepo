...
export default (
  <P.Document>
    <P.Entry id="A-MAL-48363" title="RPG Fudousan">
      <P.Source adb={48363} ks={44376} al={130319} mal={48363} />
      <P.BestGirl name="Kotone Kazairo" />
      <P.AnimeConsumedProgress status="Abandoned" boredom={0.6} episodes={5} />
      <P.Dropped />
    ...
    >
      <P.Source adb={48415} ks={44187} al={130586} mal={48415} />
      <P.BestGirl name="Ireena Litz de Olhyde" />
      <P.AnimeConsumedProgress status="Abandoned" boredom={0.5} episodes={2} />
      <P.Dropped />
      <P.Visual type="animated" base={0.5} unique={0.2} />
      <P.KilledBy id="F-VGMDB-7059" potential={0.1} effect={0.75} />
      <P.Writing character={0.3} story={0.3} pacing={0.8} originality={0.3} />
    </P.Entry>
    <P.Entry id="A-MAL-50265" title="Spy x Family">
      <P.Source adb={50265} ks={45398} al={140960} mal={50265} />
      ...
      <P.AnimeConsumedProgress status="Abandoned" boredom={0.6} episodes={4} />
      <P.Dropped />
      {/* unique art because manga, but chara design sucks */}
      {/* also fuck u boat shit */}
      <P.Visual type="animated" base={0.35} unique={0.5} />
      <P.KilledBy id="F-VGMDB-7059" potential={0.5} effect={0.75} />
      <P.Writing character={0.5} story={0.5} pacing={0.8} originality={0.9} />
    </P.Entry>
    <P.Entry id="A-MAL-50273" title="Tomodachi Game">
      <P.Source adb={50273} ks={45401} al={141014} mal={50273} />
      <P.BestGirl name="Maria Mizuse" />
      <P.AnimeConsumedProgress status="Completed" boredom={1} episodes={12} />
      {/* unique art because manga, but chara design sucks (p2) */}
      <P.Visual type="animated" base={0.2} unique={0.5} />
      <P.KilledBy id="F-VGMDB-7059" potential={0.15} effect={0.75} />
      {/* nice plot desu */}
